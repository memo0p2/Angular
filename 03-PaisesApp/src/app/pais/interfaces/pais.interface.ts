...
//
//   const conutriesResponse = Convert.toConutriesResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ConutriesResponse {
    name:         Name;
    tld:          string[];
    cca2:         string;
    ccn3:         string;
...
export class Convert {
    public static toConutriesResponse(json: string): ConutriesResponse[] {
        return cast(JSON.parse(json), a(r("ConutriesResponse")));
    }

    public static conutriesResponseToJson(value: ConutriesResponse[]): string {
        return JSON.stringify(uncast(value, a(r("ConutriesResponse"))), null, 2);
    }
}
