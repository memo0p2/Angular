// To parse this data:
//
//   import { Convert, ResponseGIF } from "./file";
//
//   const responseGIF = Convert.toResponseGIF(json);
//
...
export class Convert {
    public static toResponseGIF(json: string): ResponseGIF {
        return cast(JSON.parse(json), r("ResponseGIF"));
    }

    public static responseGIFToJson(value: ResponseGIF): string {
        return JSON.stringify(uncast(value, r("ResponseGIF")), null, 2);
    }
}
